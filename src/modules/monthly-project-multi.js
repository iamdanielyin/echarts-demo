...
// Option 2. Using live 'pageInit' event handlers for each page
    $$(document).on('pageInit', '.page[data-page="monthly-project-multi-echarts"]', function (e) {
        console.log('monthly-project-multi.pageInit');

        // 基于准备好的dom，初始化echarts实例
        const chart = echarts.init(document.getElementById('monthly-project-multi-echarts'));
        // 绘制图表
